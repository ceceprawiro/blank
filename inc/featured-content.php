...
class Featured_Content
{
    ...
    {
        add_settings_field( 'featured-content', __( 'Featured Content', THEME_TEXT_DOMAIN ), array( __class__, 'render_form' ), 'reading' );
    ...
    public static function customize_register( $wp_customize )
    {
        $wp_customize->add_section( 'featured_content', array(
            ...
            'description'    => sprintf( __( 'Easily feature all posts with the <a href="%1$s">"featured" tag</a> or a tag of your choice. Your theme supports up to %2$s posts in its featured content area.', THEME_TEXT_DOMAIN ), admin_url( '/edit.php?tag=featured' ), absint( self::$max_posts ) ),
            'priority'       => 130,
        ...
        $wp_customize->add_control( 'featured-content[tag-name]', array(
            'label'          => __( 'Tag name', THEME_TEXT_DOMAIN ),
            'section'        => 'featured_content',
            'theme_supports' => 'featured-content',
            'priority'       => 20,
        ) );
        $wp_customize->add_control( 'featured-content[hide-tag]', array(
            'label'          => __( 'Hide tag from displaying in post meta and tag clouds.', THEME_TEXT_DOMAIN ),
            'section'        => 'featured_content',
            'theme_supports' => 'featured-content',
            'type'           => 'checkbox',
            'priority'       => 30,
    ...
    {
        printf( __( 'The settings for Featured Content have <a href="%s">moved to Appearance &rarr; Customize</a>.', THEME_TEXT_DOMAIN ), admin_url( 'customize.php?#accordion-section-featured_content' ) );
    }
